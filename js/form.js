...
(function () {
  var form = document.getElementById('waveForm');
  ...
  function validate() {
    ...
    // Q4
    var q4 = form.querySelector('input[name="q4"]:checked');
    ...
    // Q5
    var q5 = form.querySelector('input[name="q5"]:checked');
  ...
  function calculateResult() {
    var tally = { bigWave: 0, mellow: 0, soul: 0, party: 0 };

    var q2Val = form.querySelector('input[name="q2"]:checked').value;
    var q3Val = document.getElementById('q3').value;
    var q4Val = form.querySelector('input[name="q4"]:checked').value;
    var q5Val = form.querySelector('input[name="q5"]:checked').value;
  ...
  form.addEventListener('submit', function (e) {
    ...
    if (!validate()) {
      ...
      var firstError = form.querySelector('.form-error[style*="block"]');
      if (firstError) {
